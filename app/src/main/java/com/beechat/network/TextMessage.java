...
public class TextMessage {
    ...
    public TextMessage(String senderId, String xbee_device_number_sender, String receiverId, String xbee_device_number_receiver, String content) {
    ...
    public TextMessage(int id, String senderId, String xbee_device_number_sender, String receiverId, String xbee_device_number_receiver, String content) {
        this.id = id;
        this.senderId = senderId;
        this.xbee_device_number_sender = xbee_device_number_sender;
        this.receiverId = receiverId;
